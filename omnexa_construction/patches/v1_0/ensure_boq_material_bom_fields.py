...
def execute():
    ...
    # document_pack_file exists in DocType JSON as a standard field, skip Custom Field creation
    if not frappe.get_meta("Construction Project Setup").has_field("document_pack_file"):
        fields["Construction Project Setup"].append(
            {
